...
20. [Добавления свойств для инфоблоков типа список](addListProps.php) 
21. [Добавления инфоблока типа список и свойств](lists.php) 
22. [Установка настроек веб-месенджера](im_settings.php) 
23. [Установка/Удаления модуля](installUninstall.php) 
24. [Добавления новые категорий сделок](addNewDealCategories.php.php) 
